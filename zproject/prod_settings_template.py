...
# zulip.example.com, or your IP address if you don't have DNS setup yet.
...
#
# The default should work unless you're using multiple hostnames.  If
# this is set wrong, all requests will get a "Bad Request" error.
