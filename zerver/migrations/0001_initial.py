    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_limits', models.CharField(default=b'', max_length=100)),
                ...
                ('avatar_source', models.CharField(default=b'G', max_length=1, choices=[(b'G', b'Hosted by Gravatar'), (b'U', b'Uploaded by user'), (b'S', b'System generated')])),
                ('tutorial_status', models.CharField(default=b'W', max_length=1, choices=[(b'W', b'Waiting'), (b'S', b'Started'), (b'F', b'Finished')])),
                ('onboarding_steps', models.TextField(default=b'[]')),
                ('invites_granted', models.IntegerField(default=0)),
                ('invites_used', models.IntegerField(default=0)),
                ('alert_words', models.TextField(default=b'[]')),
                ('muted_topics', models.TextField(default=b'[]')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(verbose_name=b'date published', db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('kind', models.PositiveSmallIntegerField(choices=[(1, b'apns'), (2, b'gcm')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=b'#c2c2c2', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_visit', models.DateTimeField(verbose_name=b'last visit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('start', models.DateTimeField(verbose_name=b'start time', db_index=True)),
                ('end', models.DateTimeField(verbose_name=b'end time', db_index=True)),
                ('user_profile', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('flags', bitfield.models.BitField([b'read', b'starred', b'collapsed', b'mentioned', b'wildcard_mentioned', b'summarize_in_home', b'summarize_in_stream', b'force_expand', b'force_collapse', b'has_alert_word', b'historical', b'is_me_message'], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('timestamp', models.DateTimeField(verbose_name=b'presence changed')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name=b'+', blank=True, to='zerver.Stream', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name=b'+', to='zerver.Stream', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='userprofile',
