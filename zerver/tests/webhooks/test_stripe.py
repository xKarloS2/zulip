...
class StripeHookTests(WebhookTestCase):
    ...
    def test_charge_failed(self):
        # type: () -> None
        expected_subject = u"Stripe"
        expected_message = u"A charge with id **[ch_00000000000000](https://dashboard.stripe.com/payments/ch_00000000000000)** for **1aud** has failed."
    ...
    def test_charge_succeeded(self):
        # type: () -> None
        expected_subject = u"Stripe"
        expected_message = u"A charge with id **[ch_00000000000000](https://dashboard.stripe.com/payments/ch_00000000000000)** for **1aud** has succeeded."
    ...
    def test_invoice_payment_failed(self):
        # type: () -> None
        expected_subject = u"Stripe"
        expected_message = u"An invoice payment on invoice with id **[in_00000000000000](https://dashboard.stripe.com/invoices/in_00000000000000)** and with **0aud** due has failed."
    ...
    def test_order_payment_failed(self):
        # type: () -> None
        expected_subject = u"Stripe"
        expected_message = u"An order payment on order with id **[or_00000000000000](https://dashboard.stripe.com/orders/or_00000000000000)** for **15aud** has failed."
    ...
    def test_order_payment_succeeded(self):
        # type: () -> None
        expected_subject = u"Stripe"
        expected_message = u"An order payment on order with id **[or_00000000000000](https://dashboard.stripe.com/orders/or_00000000000000)** for **15aud** has succeeded."
    ...
    def test_order_updated(self):
        # type: () -> None
        expected_subject = u"Stripe"
        expected_message = u"The order with id **[or_00000000000000](https://dashboard.stripe.com/orders/or_00000000000000)** for **15aud** has been updated."
    ...
    def test_transfer_failed(self):
        # type: () -> None
        expected_subject = u"Stripe"
        expected_message = u"The transfer with description **Transfer to test@example.com** and id **[tr_00000000000000](https://dashboard.stripe.com/transfers/tr_00000000000000)** for amount **11aud** has failed."
    ...
    def test_transfer_paid(self):
        # type: () -> None
        expected_subject = u"Stripe"
        expected_message = u"The transfer with description **Transfer to test@example.com** and id **[tr_00000000000000](https://dashboard.stripe.com/transfers/tr_00000000000000)** for amount **11aud** has been paid."
